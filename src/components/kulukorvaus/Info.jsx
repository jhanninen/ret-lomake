...
const Info = (props) => (
  <div>
    ...
    <p>
      ...
      Liitä viestiin mukaan myös kuitit hankinnoista skannatuina tai hyvälaatuisina valokuvina. Tarkemmat ohjeet ovat lomakkeen lopussa.
    </p>
    <p>
    ...
    <p>
      Jos lomakkeen täyttämisessä tulee ongelmia tai ilmenee muuta kysyttävää, ole yhteydessä taloudenhoitajaan (Juhoon) sähköpostilla tai puhelimella 0404191804.
    </p>
  </div>
);
